...
// XBPayment
#define COCOAPODS_POD_AVAILABLE_XBPayment
#define COCOAPODS_VERSION_MAJOR_XBPayment 0
#define COCOAPODS_VERSION_MINOR_XBPayment 4
#define COCOAPODS_VERSION_PATCH_XBPayment 1
